              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                    if(!empty($location_array))
                    {
                        ...
                        {
                            $delete_url = url('/categorydel')."/".$location_arr['category_id'];
                            $edit_url   = url('/categoryedit')."/".$location_arr['category_id'];
                ?>
                            <tr>
                                <td><?php echo $count; ?></td>
                                <td><?php if(!empty($location_arr['category'])) echo $location_arr['category']; ?></td>
                                <td><?php if(!empty($location_arr['category_code'])) echo $location_arr['category_code']; ?></td>
