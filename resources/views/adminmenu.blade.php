...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">  
          ...
          <li <?php if($subclass == 'studentboard') { ?> class="active" <?php } ?>>
              <a href="{{ url('/studentboard') }}">
                  <i class="fa fa-dashboard"></i> <span>Dashboard</span>
              </a>
          </li> 
          <li <?php if($subclass == 'studentorders') { ?> class="active" <?php } ?>>
              <a href="{{ url('/studentorders') }}">
                  <i class="fa fa-calendar"></i> <span>Orders</span>
              </a>
          </li>
          <li <?php if($subclass == 'studentcourse') { ?> class="active" <?php } ?>>
              <a href="{{ url('/studentcourse') }}">
                  <i class="fa fa-mortar-board"></i> <span>Course</span>
              </a>
          </li>
          <li <?php if($subclass == 'material') { ?> class="active"  <?php } ?>>
              <a href="{{ url('/material') }}">
                  <i class="fa fa-mortar-board"></i> <span>Material</span>
              </a>
          </li>          
          <li <?php if($subclass == 'studentprofile') { ?> class="active" <?php } ?>>
          ...
          @else 
          <li <?php if($subclass == 'home') { ?> class="active" <?php } ?>>
              <a href="{{ url('/home') }}">
                  <i class="fa fa-dashboard"></i> <span>Dashboard</span>
              </a>
          </li>

          <li <?php if($subclass == 'settings') { ?> class="active" <?php } ?>>
              <a href="{{ url('/settings') }}">
        ...
        <li <?php if($mainclass == 'usermanagement') { ?> class="active treeview" <?php } else { ?> class="treeview" <?php } ?>>
          ...
          <ul class="treeview-menu">
            <li <?php if($subclass == 'rolemgt') { ?> class="active" <?php } ?>><a href="{{ url('/rolemgt') }}"><i class="fa fa-user"></i>List Role</a></li>
            <li <?php if($subclass == 'rolemgtadd') { ?> class="active" <?php } ?>><a href="{{ url('/rolemgtadd') }}"><i class="fa fa-user-plus"></i>Add Role</a></li>	
            ...
            <li <?php if($subclass == 'usermgt') { ?> class="active" <?php } ?>><a href="{{ url('/usermgt') }}"><i class="fa fa-user"></i>List Users</a></li>
            <li <?php if($subclass == 'usermgtadd') { ?> class="active" <?php } ?>><a href="{{ url('/usermgtadd') }}"><i class="fa fa-user-plus"></i>Add User</a></li>
          </ul>
        </li> 
        
        <li <?php if($mainclass == 'packagemanagement') { ?> class="active treeview" <?php } else { ?> class="treeview" <?php } ?>>
          <a href="#">
            <i class="fa fa-users"></i>
          ...
          <ul class="treeview-menu">
            <li <?php if($subclass == 'packagelist') { ?> class="active" <?php } ?>><a href="{{ url('/packagemgt') }}"><i class="fa fa-user"></i>List Packages</a></li>
            <li <?php if($subclass == 'packageadd') { ?> class="active" <?php } ?>><a href="{{ url('/packagemgtadd') }}"><i class="fa fa-user-plus"></i>Add Packages</a></li>
          </ul>
        </li>         
          
        <li <?php if($mainclass == 'materialmanagement') { ?> class="active treeview" <?php } else { ?> class="treeview" <?php } ?>>
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li <?php if($subclass == 'materiallist') { ?> class="active" <?php } ?>><a href="{{ url('/materialmgt') }}"><i class="fa fa-th-large"></i>All Materials</a></li>
            <li <?php if($subclass == 'materialadd') { ?> class="active" <?php } ?>><a href="{{ url('/materialadd') }}"><i class="fa fa-plus"></i>Add Material</a></li>

          </ul>
        </li> 
        
        <li <?php if($mainclass == 'classmanagement') { ?> class="active treeview" <?php } else { ?> class="treeview" <?php } ?>>
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li <?php if($subclass == 'classlist') { ?> class="active" <?php } ?>><a href="{{ url('/classmgt') }}"><i class="fa fa-th-large"></i>All Classes</a></li>
            <li <?php if($subclass == 'classadd') { ?> class="active" <?php } ?>><a href="{{ url('/classadd') }}"><i class="fa fa-plus"></i>Add Class</a></li>                  
         </ul>
        </li> 
          
        <li <?php if($mainclass == 'ordermanagement') { ?> class="active treeview" <?php } else { ?> class="treeview" <?php } ?>>
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li <?php if($subclass == 'orderlist') { ?> class="active" <?php } ?>><a href="{{ url('/ordermgt') }}"><i class="fa fa-th-large"></i>All Orders</a></li>
            <li <?php if($subclass == 'orderadd') { ?> class="active" <?php } ?>><a href="{{ url('/ordermgtadd') }}"><i class="fa fa-plus"></i>Add Order</a></li>                  
         </ul>
        </li>            

        <li <?php if($mainclass == 'questionmanagement') { ?> class="active treeview" <?php } else { ?> class="treeview" <?php } ?>>
            <a href="#">
              <i class="fa fa-adn"></i>
            ...
            <ul class="treeview-menu">
               <li <?php if($subclass == 'speaking') { ?> class="active" <?php } ?>><a href="{{ url('/questionmgt/speaking') }}"><i class="fa teamspeak"></i>Speaking</a></li>
               <li <?php if($subclass == 'listening') { ?> class="active" <?php } ?>><a href="#"><i class="fa fa-assistive-listening-systems"></i>Listening</a></li>                  
               <li <?php if($subclass == 'reading') { ?> class="active" <?php } ?>><a href="#"><i class="fa teamspeak"></i>Reading</a></li>
               <li <?php if($subclass == 'writing') { ?> class="active" <?php } ?>><a href="#"><i class="fa fa-assistive-listening-systems"></i>Writing</a></li>                  
            </ul>
          </li>   
          
        <li <?php if($mainclass == 'emailmanagement') { ?> class="active treeview" <?php } else { ?> class="treeview" <?php } ?>>
          <a href="#">
            <i class="fa fa-files-o"></i>
          ...
          <ul class="treeview-menu">
            <li <?php if($subclass == 'templatelist') { ?> class="active" <?php } ?>><a href="{{ url('/notificationmgt') }}"><i class="fa fa-th-large"></i>All Templates</a></li>
            <li <?php if($subclass == 'templateadd') { ?> class="active" <?php } ?>><a href="{{ url('/notificationadd') }}"><i class="fa fa-plus"></i>Add Template</a></li>                  
         </ul>
        </li> 
        @endif          		  
