...
<button id="addnew" class="btn btn-success">
  ...
  <div class="btn-group">
      ...
      <button id="dropdown-toggle" type="button" data-toggle="dropdown" class="btn btn-default dropdown-toggle"><span class="caret"></span></button>
...
<table id="table"
     ...
     data-url="/questionmgt/questiondata"
