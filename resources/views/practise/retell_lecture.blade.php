                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box collapsed-box box-solid">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Show Transcript and Sample Answer</h3>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-xs-10 col-md-offset-1 text-left highlight">
                                            {{ $Question['Transcript'] }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group margin">
                                        <div class="input-group-btn">
                                            <button type="button" class="btn bg-navy">Key Words</button>
                                        </div>
                                        <!-- /btn-group -->
                                    ...
                                    <div class="box collapsed-box box-solid">
                                        <div class="box-header with-border">
                                            <h3 class="box-title">Show Sample Answer</h3>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="col-xs-12">
                                                <h5>General Template Response</h5>
                                                <div class="row is-table-row">
                                                    <div id="answer-play-button" class="col-xs-1"><a class="btn btn-app"><i
                                                                class="fa fa-play"></i> Play</a></div>
                                                    <div id="answer-step-backward-button" class="col-xs-1"><a class="btn btn-app"><i
                                                                class="fa fa-step-backward"></i> Play</a></div>
                                                    <div id="answer-audio-play" class="col-xs-8"></div>
                                                    <div id="answer-tracktime" class="col-xs-2" style="margin-top:20px"></div>
                                                </div>
                                            </div>
                                            <!-- class="col-xs-12" -->
                                            ...
                                            <div class="col-xs-12">
                                                <table class="table table-sm">
                                                    <tbody>
                                                        @for ($i = 0; $i < sizeof($Question['Comments']); $i++)
                                                        <tr>
                                                            <th scope="row">{{ $i+1 }}</th>
                                                            <td>{{ $Question['Comments'][$i] }}</td>
                                                        </tr>
                                                        @endfor
                                                    </tbody>
                                                </table>
                                            ...
                                            <div class="form-group col-xs-12">
                                                <label for="alt_keywords">Alternative Keyword Suggestions</label>
                                                <textarea class="form-control" rows="5" id="alt_keywords" disabled>
                                                    @for ($i = 0; $i < sizeof($Question['Keywords_alt']); $i++)
                                                        {{ ($i+1).'. '.$Question['Keywords_alt'][$i] }}
                                                    @endfor
                                                </textarea>
                                            </div>
