        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    @for ($i = 0; $i < sizeof($Question['Image']); $i++)
                    <img id="{{ 'dragImg'.($i+1) }}" alt="{{ 'Answer'.($i+1) }}"
                        src="{{ URL::to('/').$Question['Image'][$i] }}" draggable="true" ondragstart="drag(event)" />
                    @endfor
...
<script type="text/javascript">
    ...
    function drop(ev) {
        ...
        var data1 = document.getElementById(data).alt;
        document.getElementById(ev.target.id).value = data1;
    }
